...
!function (t) {
    ...
    function e(e, a, r) {
        ...
        return i = e.element.css({
            ...
            return n += o, t += Math.ceil(o * c), t > s.w && n < s.h ? e.element.css({"background-size": ""}) : (n > t / c ? (p = Math.ceil(n * c), l = n) : (p = t, l = Math.ceil(t / c)), i.css({"background-size": p + "px " + l + "px"}), void 0)
        }, d.onerror = function () {
        }, d.onload = function () {
            s = {
                w: d.width,
